    ...
    constructor() {
        const config = {
            ...
            performanceThresholds: [
                ...
                { threshold: 200, message: '👏 Great job! You show strong organizational skills!' },
                { threshold: 150, message: '👍 Good work! Keep developing your time management skills.' },
                { threshold: 0, message: '📚 Review the time management guide and try again!' }
            ]
        };
