...
export class FunctionalInterviewQuiz extends BaseQuiz {
        ...
        const checkTimerSettings = () => {
            ...
            if (this.timePerQuestion !== undefined && this.timePerQuestion !== null) {
                ...
                if (restoredTime !== null) {
                    ...
                    console.log(`[FunctionalInterviewQuiz] Will restore timer to ${restoredTime}s`);
                }
    ...
    initializeTimer() {
        ...
        if (this.persistedTimeRemaining !== null) {
            ...
            console.log(`[FunctionalInterviewQuiz] Resuming timer with ${timeLeft}s remaining`);
        } else {
            timeLeft = this.timePerQuestion;
            console.log(`[FunctionalInterviewQuiz] Starting new timer with ${timeLeft}s`);
        }
        
        // If timer is 0 or disabled, hide timer and continue without timing
        if (timeLeft <= 0) {
            console.log('[FunctionalInterviewQuiz] Timer disabled (0 seconds)');
