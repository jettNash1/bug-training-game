...
import { functionalInterviewScenarios } from '../data/functional-interview-scenarios.js';
...
export class FunctionalInterviewQuiz extends BaseQuiz {
    ...
    showError(message) {
        console.error('[Functional Interview Quiz] Error:', message);
        ...
        try {
            ...
            if (container) {
                ...
                console.error('[Functional Interview Quiz] Displayed error to user:', message);
            }
        } catch (e) {
