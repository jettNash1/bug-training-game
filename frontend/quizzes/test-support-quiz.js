...
export class TestSupportQuiz extends BaseQuiz {
    ...
    getTimerStorageKey() {
        ...
        return `test-support_timer_${this.player.username}_q${questionIndex}`;
    }
    ...
    clearAllTimerStates() {
        try {
            ...
            const prefix = `test-support_timer_${this.player.username}_`;
            ...
            console.log('[TestSupportQuiz] Cleared all timer states');
        } catch (error) {
