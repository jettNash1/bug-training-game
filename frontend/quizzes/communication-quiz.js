...
export class CommunicationQuiz extends BaseQuiz {
    ...
    displayScenarioContent(scenario) {
        ...
        if (this.timePerQuestion === 0 || this.timerDisabled) {
            console.log('[CommunicationQuiz] Timer is disabled, hiding timer container');
    ...
    initializeTimer() {
        ...
        // Check if timer is disabled
        if (this.timePerQuestion === 0 || this.timerDisabled) {
            console.log('[CommunicationQuiz] Timer is disabled, not initializing timer');
            const timerContainer = document.getElementById('timer-container');
            if (timerContainer) {
                timerContainer.style.display = 'none';
            }
    ...
    handleTimeUp() {
        ...
        if (this.timePerQuestion === 0 || this.timerDisabled) {
            console.log('[CommunicationQuiz] Timer is disabled, ignoring time up event');
            return;
        }
