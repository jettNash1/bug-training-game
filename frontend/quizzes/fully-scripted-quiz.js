...
export class FullyScriptedQuiz extends BaseQuiz {
    ...
    getTimerStorageKey() {
        ...
        return `fully-scripted_timer_${this.player.username}_q${questionIndex}`;
    }
    ...
    clearAllTimerStates() {
        try {
            ...
            const prefix = `fully-scripted_timer_${this.player.username}_`;
            ...
            console.log('[FullyScriptedQuiz] Cleared all timer states');
        } catch (error) {
