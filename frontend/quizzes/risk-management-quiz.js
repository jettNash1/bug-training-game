...
export class RiskManagementQuiz extends BaseQuiz {
    ...
    getTimerStorageKey() {
        ...
        return `risk-management_timer_${this.player.username}_q${questionIndex}`;
    }
    ...
    clearAllTimerStates() {
        try {
            ...
            const prefix = `risk-management_timer_${this.player.username}_`;
            ...
            console.log('[RiskManagementQuiz] Cleared all timer states');
        } catch (error) {
